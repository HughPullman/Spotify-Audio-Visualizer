...
const Sphere = (props) => {
  ...
  const uniforms = useMemo(() =>{
    return{
      uResolution:{type: 'v2', value: new THREE.Vector2(window.innerWidth - 270, window.innerHeight- 175)},
      uTime: {value: 0.0},
  ...
  useEffect(() =>{
    materialRef.current.uniforms.uFrequency.value = amplitudeBeat;
  }, [amplitudeBeat])


  return (
    <Center>
        <mesh geometry={sphereGeometry} ref={sphereRef}>
          <shaderMaterial
          ref={materialRef} 
          wireframe
          vertexShader={`
